  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <Card className="border-[#243d21] bg-[#111f0f]">
        <CardHeader>
          <CardTitle className="text-[#edf2ea]">Acesse sua conta</CardTitle>
        ...
        <CardContent>
          ...
          <div className="relative my-5">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#243d21]" />
            </div>
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#111f0f] px-2 text-[#6b9464]">ou</span>
            </div>
          </div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-[#243d21] bg-[#0a1209] text-[#edf2ea] hover:bg-[#1a2f17] hover:text-[#edf2ea]"
